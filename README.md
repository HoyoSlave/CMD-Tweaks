...
## Configuration Paths
* **Perflist Path:**
  `/storage/emulated/0/Android/media/.sosp/perflist.txt`
* **Settings Path:**
  `/storage/emulated/0/Android/media/.sosp/settings.ini`
* **Game Scale List:**
  `/storage/emulated/0/Android/media/.sosp/gamelist.txt`
