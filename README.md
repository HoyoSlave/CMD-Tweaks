...
* **[root] Fast Charging:** Disabling thermal services
  * turn it on, wait 5 seconds, plug in the charger. will automatically turn off if the charger is unplugged
* **Disable Device Sensors:** Disabling gyroscope, camera, etc
  * reduce cpu load
* **Disable Google Protect:** Disabling daily scanning and protection
  * reduce cpu load
* **Disable Google Services:** Disabling google account, contact, etc
  * reduce memory usage *sync your contact
* **Disable Network Stats:** Disabling network statistics
  * increase network downloading speed
* **Enable Data Saver:** Restricts background data usage
  * increase network stability for top app
* **Enable Doze Mode:** Restricts background activity
  * reduce memory usage
